...
我用的豆包比较顺手，其他gpt image2，nano banana 我没试过应该都一样
可以参考这个提示词：
...
> [!IMPORTANT]
> <span style="color:red">开始绘制前，必须先在小程序里打开画笔的「大小」调整界面，让大小滑块显示在屏幕底部。App 会根据你在 App 里选择的画笔粗细，自动点击这个滑块位置。</span>
...
- 图片越简单，识别和绘制效果越稳定。
- <span style="color:red">开始前必须打开小程序画笔「大小」调整界面，否则 App 无法自动设置正确画笔粗细。</span>
- 最细画笔的打印效果可能不佳，建议根据预览在 App 界面适当调大画笔粗细。
